                            ...
                            <tbody>
                                <tr>
                                    <th className='grid grid-cols-4 mt-6'>
                                        <img src='img/book/content1/tim-me_76ec52df32c24078812c66694f5fc4c7_large.png' alt='' />
                                        <div className='col-span-3 pl-4 text-start'>
                                            <div className='text-xl text-red-600'>Tìm mẹ và các truyện dân gian khác (Kỉ niệm 65 năm NXB Kim Đồng)</div>
                                            <div className='font-normal my-2'>Khuyến mãi: 1017960497 - Giảm vô thời hạn 10% cho toàn bộ Sách Kim Đồng</div>
